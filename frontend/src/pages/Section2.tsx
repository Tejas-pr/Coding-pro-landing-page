    ...
    <>
     <div className="bg-no-repeat bg-left bg-hero-pattern">
        ...
        <div className="flex flex-col justify-center items-center mt-8 space-y-8 px-4">
          {/* card 1 */}
          <div className="flex flex-col md:flex-row bg-white shadow-lg items-center p-6 md:p-8 gap-6 md:gap-10 w-full max-w-lg md:max-w-4xl">
          ...
          {/* <img src={dots} alt="rounddisk" className="mb-4 hidden md:block md:translate-x-96 md:-translate-y-96 -z-10" /> */}
